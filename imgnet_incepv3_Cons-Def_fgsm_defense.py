...
#        feed_dict = {input_images: val_x_bat + 0.5, input_labels: val_y_bat, is_training: False}
        feed_dict = {input_images: val_x_bat, is_training: False}
#input_labels is needed for loss
...
###########################################
#uncomment statements below for 64 aug test
#  ext_bat = ext_bat + 1
#  n_pert = n_pert + 1
#  y_test_ext = y_test
#  logits_ext = cur_preds
#  logits_adv_ext = cur_preds_adv
###########################################

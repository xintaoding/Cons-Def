...
with tf.Session() as sess:
  ...
  #########################################Added by Ding  
    ...
    saver.restore(sess,'models/caffe_ilsvrc12/resnet101_clean_models_197500_0.7300.ckpt')
    print("aaaaaaaaaaaaaaaaa=************************************")
...
#    np.save("imagenet_ResNet101_augmodel_pgd_10000adv",adv)#save advs 
    batch_size = 10  

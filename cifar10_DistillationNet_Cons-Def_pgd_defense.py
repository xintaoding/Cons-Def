...
#                                  input_shape=[32, 32, 3])#Load the model graph of all conv
  net_height=32
  net_width=32
  model = Model4Convolutional2FC('model1', nb_classes, nb_filters, input_shape=[net_height, net_width, nchannels])#Load the model graph of 4 conv and 2 fc layers, Revised by Ding==========
...
#  adv=np.load("cifar10_DistillationNet_augmodel_pgd_10000adv.npy")

...
def create_graph():
  ...
  with tf.gfile.FastGFile(
    #  FLAGS.model_dir, 'classify_image_graph_def.pb'), 'rb') as f:
      'models/cifar10/vgg16_models_1783000_0.8809.pb', 'rb') as f:
...
#    yname = adv_ys
    ...
    self.initial_const = 10.0#'initial_const': 10#10 is the default set of cleverhans,0.001 is the CW author proposed
...
#  adv=np.load("cifar10_vgg16_augmodel_cwl2_10000adv.npy")#load advs  
...
#        adv_bat = adv[i*batch_size:(i+1)*batch_size,:,:,:]
  ...
  np.save("cifar10_vgg16_augmodel_cwl2_10000adv",adv)#save advs  

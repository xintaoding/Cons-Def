...
#  adv=np.load("cifar10_DistillationNet_augmodel_deepfool_10000adv.npy")
  np.save("cifar10_DistillationNet_augmodel_deepfool_10000adv",adv)#save advs produced on clean model:

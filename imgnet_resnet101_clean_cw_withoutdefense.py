...
def create_graph():
  ...
  with tf.gfile.FastGFile(
    #  FLAGS.model_dir, 'classify_image_graph_def.pb'), 'rb') as f:
      'models/caffe_ilsvrc12/resnet101_clean_models_197500_0.7300.pb', 'rb') as f:
...
#      assert 1==2
      output_name = "resnet_v1_101/SpatialSqueeze:0"
    else:
      output_name = 'resnet_v1_101/Softmax:0'
...
#      output_name = 'InceptionV3/Predictions/Reshape:0'
    ...
    # scaled = (0.5+img)*255
    print("Resnet101.predict:{},img.shape:{}".format(output_name,img.shape))
...
#  adv=np.load("imagenet_ResNet101_augmodel_cwl2_10000adv.npy")#save advs
...
#  np.save("imagenet_ResNet101_augmodel_cwl2_10000adv",adv)#save advs
